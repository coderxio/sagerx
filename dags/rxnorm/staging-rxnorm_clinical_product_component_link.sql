...
DROP TABLE IF EXISTS staging.rxnorm_clinical_product_component_link;
...
left join datasource.rxnrel rxnrel on rxnrel.rxcui2 = product.rxcui and rxnrel.rela = 'contains'
left join datasource.rxnconso product_component on rxnrel.rxcui1 = product_component.rxcui and product_component.tty = 'SCD'
