/* datasource.cms_pharmacy_networks_file_2 */
DROP TABLE IF EXISTS datasource.cms_pharmacy_networks_file_2 CASCADE;

CREATE TABLE datasource.cms_pharmacy_networks_file_2 (
...
COPY datasource.cms_pharmacy_networks_file_2
