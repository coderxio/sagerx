/* datasource.cms_plan_information_file */
DROP TABLE IF EXISTS datasource.cms_plan_information_file CASCADE;

CREATE TABLE datasource.cms_plan_information_file (
...
COPY datasource.cms_plan_information_file
