...
left join datasource.rxnrel on rxnrel.rxcui2 = product.rxcui and rxnrel.rela = 'has_ingredient'
left join datasource.rxnconso brand on rxnrel.rxcui1 = brand.rxcui and brand.tty = 'BN'
