...
inner join datasource.rxnorm_rxnconso ingredient on ingredient.rxcui = has_ingredient.rxcui1 and ingredient.tty = 'IN'
...
inner join datasource.rxnorm_rxnconso product_component on product_component.rxcui = constitutes.rxcui1 and product_component.tty = 'SCD'
