/* datasource.cms_partial_gap_coverage */
DROP TABLE IF EXISTS datasource.cms_partial_gap_coverage CASCADE;

CREATE TABLE datasource.cms_partial_gap_coverage (
...
COPY datasource.cms_partial_gap_coverage
