/* datasource.cms_pharmacy_networks_file_3 */
DROP TABLE IF EXISTS datasource.cms_pharmacy_networks_file_3 CASCADE;

CREATE TABLE datasource.cms_pharmacy_networks_file_3 (
...
COPY datasource.cms_pharmacy_networks_file_3
