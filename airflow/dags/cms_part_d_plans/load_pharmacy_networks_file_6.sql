/* datasource.cms_pharmacy_networks_file_6 */
DROP TABLE IF EXISTS datasource.cms_pharmacy_networks_file_6 CASCADE;

CREATE TABLE datasource.cms_pharmacy_networks_file_6 (
...
COPY datasource.cms_pharmacy_networks_file_6
