/* datasource.cms_pharmacy_networks_file_5 */
DROP TABLE IF EXISTS datasource.cms_pharmacy_networks_file_5 CASCADE;

CREATE TABLE datasource.cms_pharmacy_networks_file_5 (
...
COPY datasource.cms_pharmacy_networks_file_5
